#!/usr/bin/env bash
# Instala (o quita) el LaunchAgent que corre el sync diario de métricas de IG
# a las 21:30. Genera el plist con rutas absolutas del repo actual, lo valida
# con plutil y lo carga con launchctl bootstrap. Idempotente.
#
#   ./scripts/instalar_sync_diario.sh              instala/recarga
#   ./scripts/instalar_sync_diario.sh --quitar     desinstala
...
LABEL="com.gdlscene.sync-metrics"
...
LOG="$REPO/data/launchd_sync.log"
...
instalar() {
    ...
    echo "Cargado en launchd: corre diario a las 21:30."
